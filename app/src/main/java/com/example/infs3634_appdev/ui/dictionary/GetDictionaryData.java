...
public class GetDictionaryData extends AsyncTask<String, Integer, String> {
    Context context;
    TextView showDef;

    public GetDictionaryData(Context context, TextView tV){
    ...
    protected String doInBackground(String... params) {
        ...
        final String app_id = "346905f4";
        final String app_key = "48f0f2641b3ba6795b4e0b32ccc1459d";
        try {
